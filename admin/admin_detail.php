				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<form method="post" action="update_act_tb_admin.php" name='form-edit-data-admin'>
								<!-- Kode Admin -->
								...
								<div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                <input id="email_admin" name="email_admin" placeholder="Email" class="form-control here" required="required" value="<?php echo $data['email_admin']?>" type="text" disabled>
	                                </div>
								</div>
								...
								<div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                <input id="user_admin" name="user_admin" placeholder="Username" class="form-control here" required="required" value="<?php echo $data['user_admin']?>" type="text" disabled>
	                                </div>
								</div>
								...
								<div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                <input id="pass_admin" name="pass_admin" placeholder="Password" class="form-control here" required="required" value="<?php echo $data['pass_admin']?>" type="password" disabled>
	                                </div>
								</div>
								...
								<div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                <input id="nama_admin" name="nama_admin" placeholder="Nama Lengkap" class="form-control here" required="required" value="<?php echo $data['nama_admin']?>" type="text" disabled>
	                                </div>
								</div>
							</form>
						</div>
