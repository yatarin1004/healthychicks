...
<body>
	<div class="main-bg">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12">
							<form method="post" action=" " name='form-input-data-gejala'>
								<!-- Kode Gejala -->
								<td><input type="hidden" name="kd_gejala" class="form-control" required></td>

								<!-- Jenis Gejala -->
								<div class="form-group row">
									<label for="jnsgejala" class="col-4 col-form-label">Jenis Gejala*</label> 
	                                <div class="col-8">
	                                <input id="jns_gejala" name="jns_gejala" placeholder="Jenis Gejala" class="form-control here" required="required" type="text">
	                                </div>
								</div>
		...
		{
			//menerima input dari form di create_tb_gejala.php
			$kd_gejala		= @$_POST["kd_gejala"];
			$jns_gejala		= @$_POST["jns_gejala"];

			//query input data ke dalam tabel tb_gejala
			$query	= "INSERT INTO tb_gejala (kd_gejala,jns_gejala) VALUES ('$kd_gejala','$jns_gejala')";
