...
<head>
	...
	<title>Tabel Daftar Diagnosa</title>
</head>
    						...
    						<table class="table table-borderless table-striped table-hover">
    							<thead class="thead">
								    <tr>
								    	...
								    	<th scope="col" style="width: 30%;">Daftar Gejala</th>
								    	<th scope="col" style="width: 30%;">Diagnosa Penyakit</th>
								    	<th scope="col" style="width: 5%;">Nilai</th>
								    	<th scope="col" style="width: 5%;">Persentase</th>
								...
								<tbody>
									<?php 
										include "../config.php";
										$no		= 1; 
										$query	= mysqli_query($config, 'SELECT * FROM tb_diagnosa');
							        		while ($data = mysqli_fetch_array($query)) {
							        			?>
							        				<tr>
							        					<td><?php echo $no++ ?></td>
							        					<td><?php echo $data['kd_diagnosa']; ?></td>
							        					<td><?php echo $data['dftr_gejala']; ?></td>
							        					<td><?php echo $data['diag_penyakit']; ?></td>
							        					<td><?php echo $data['nilai']; ?></td>
							        					<td><?php echo $data['persentase']; ?></td>
							        					<td>
							        						<!-- Detail -->
						        							<a href="diagnosa_detail.php? kd_diagnosa=<?php echo $data['kd_diagnosa']; ?>" class="btn btn-info btn-block"><i class="fa-solid fa-circle-info"></i></a>
							        					</td>
							        				</tr>
							        			<?php } 
							        			?>
