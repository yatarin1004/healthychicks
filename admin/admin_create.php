...
<body>
	<div class="main-bg">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12">
							<form method="post" action=" " name='admin-create'>
								<!-- Kode Admin -->
								<td><input type="hidden" name="kd_admin" class="form-control" required></td>

								<!-- Email -->
								<div class="form-group row">
									<label for="email" class="col-4 col-form-label">Email*</label> 
	                                <div class="col-8">
	                                <input id="email_admin" name="email_admin" placeholder="Email" class="form-control here" required="required" type="text">
	                                </div>
								</div>
								...
								<div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                <input id="user_admin" name="user_admin" placeholder="Username" class="form-control here" required="required" type="text">
	                                </div>
								</div>
								...
								<div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                <input id="pass_admin" name="pass_admin" placeholder="Password" class="form-control here" required="required" type="password">
	                                </div>
								</div>
								...
								<div class="form-group row">
	                                ...
	                                <div class="col-8">
	                                <input id="nama_admin" name="nama_admin" placeholder="Nama Lengkap" class="form-control here" required="required" type="text">
	                                </div>
								</div>
		...
		{
			//menerima input dari form di create_tb_admin.php
			...
			//query input data ke dalam tabel tb_admin
			$query	= "INSERT INTO tb_admin (kd_admin,email_admin,user_admin,pass_admin,nama_admin) VALUES ('$kd_admin','$email_admin','$user_admin','$pass_admin','$nama_admin')";
