...
<head>
	...
	<!-- CSS Link -->
	<link rel="stylesheet" type="text/css" href="create_tb_penyakit_gejala.css">

	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Edit Data Aturan</title>
</head>
...
<body>
	<div class="main-bg">
    	...
    	<div class="col-md-12">
    		<div class="card">
    			<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12">
							<form method="post" action=" " name='aturan-update'>
    							...
    							<div class="form-group row">
	                                ...
	                                <select class="custom-select" name="kd_penyakit" id="kd_penyakit" required>
										...
										$no++;
										?>
											<option value="<?php echo $data['kd_penyakit'];?>"
												<?php
												echo "selected";
												?>
												>[<?php echo $data['kd_penyakit'];?>] <?php echo $data['nama_penyakit'];?></option>
										<?php 
										}
										?>
	                                </select>
								...
								<div class="form-group row">
	                                ...
	                                <select class="custom-select" id='pre-selected-options' name="kd_gejala" required>
										...
										$no++;
										?>
											<option value="<?php echo $data['kd_gejala'];?>"
												<?php
												echo "selected";
												?>
												>[<?php echo $data['kd_gejala'];?>] <?php echo $data['jns_gejala'];?></option>
										<?php 
										}
										?>
									 </select>
		...
		if(isset($_POST['simpan']))
		{
			...
			$query	= "UPDATE tb_penyakit_gejala SET
				kd_p_g				='$kd_p_g',
				kd_penyakit			='$kd_penyakit',
				kd_gejala			='$kd_gejala',
				n_densitas			='$n_densitas'
				WHERE kd_p_g		='$kd_p_g' ";
